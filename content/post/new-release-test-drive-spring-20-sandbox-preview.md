---
{
  ...
  "layout": "single",
  "thumbnail": {
    "url": "/img/butterfly.jpeg"
  }
}
---


{{< image src="/img/butterfly.jpeg" title="Butterfly on a flower" >}}
...
*[Update: [The release notes are here](https://releasenotes.docs.salesforce.com/en-us/spring20/release-notes/salesforce_release_notes.htm)!]*
...
{{< image src="/img/arrow-pointing-to-gear.jpeg" title="Arrow pointing to the gear" >}}

And then click “Setup” in the dropdown menu.

{{< image src="/img/clicking-setup.jpeg" title="Clicking the setup gear" >}}

That’ll take you to the Setup Homepage.

{{< image src="/img/setup-home.jpeg" title="Setup Home" >}}
...
{{< image src="/img/list-of-sandboxes.jpeg" title="List of sandboxes" >}}
...
{{< image src="/img/sandbox-timelines.jpeg" title="Sandbox timelines" >}}
...
{{< image src="/img/arrow-pointing-to-refresh.jpeg" title="Arrow pointing to refresh links" >}}
...
{{< image src="/img/salesforce-guy-in-forest.jpeg" title="Salesforce guys in the forest" >}}
