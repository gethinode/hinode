---
{
  ...
  "tags": ["salesforce","crm","nonprofit","philanthropy","charity"],
  "author": {
    "name": Chris Stegall,
  ...
  "layout": "single",
  "thumbnail": {
    "url": "/img/1_RATejxydAB3i_CFuZ59Qlg.jpeg"
  }
}
---
The foundation of every nonprofit is people. The founders who saw an opportunity and envisioned an organization that could help, the employees and volunteers who keep operations running smoothly, the donors and patrons who fund the efforts and spread the word, and the beneficiaries whose lives are improved.
...
{{< image src="/img/1_QE9VaePU9bldWkjTNEgCOw.jpeg" title="Image" >}}
...
{{< image src="/img/1_aQg0hOchmH0eV8BM6wMlcA.jpeg" title="Image" >}}

Everything you do matters. With finite resources and noble goals, wasted efforts are missed opportunities to better serve your cause. With Salesforce, you have the ability to [track, record, and dive into any of your data](https://www.salesforce.org/nonprofit/analytics/), empowering you and your organization to make more informed decisions.
...
{{< image src="/img/1_vcDCXTymJMF4KBsSlYdFXQ.jpeg" title="Image" >}}
...
{{< image src="/img/1_qk8tpFPmDi81Jhbo9jBINQ.jpeg" title="Image" >}}
...
{{< image src="/img/1_SjhV_a0Ocsaal6YRUD7sBg.jpeg" title="Image" >}}
...
With [Salesforce Community Cloud](https://www.salesforce.org/nonprofit/collaborate/), rolling out online communities is easier than ever. With your branding, your messaging, and your functionality — all without having to worry about how to code accounts, passwords, usernames, etc… .
...
{{< image src="/img/1_de5I0QNVKnT_OXYM60nHAQ.jpeg" title="Image" >}}
...
The NPSP enables organizations to manage donations, memberships, relationships, and company affiliations right out of the box, as well as gifts, recurring payments and so much more. And at MK Partners we’re especially well-equipped to help organizations get it rolling smoothly because our CTO helped develop the original NPSP in the early days of Salesforce!
For a more in-depth overview of all the features and benefits of NPSP and a look at how other nonprofits have found success using it, there’s an awesome [PDF](http://pardot.mkpartners.com/NPSPHighlights) that breaks it down [right here](http://pardot.mkpartners.com/NPSPHighlights)!

## 

{{< image src="/img/1_3eXm2FjoE6ar44Zv2ydZaw.jpeg" title="Image" >}}
...
{{< image src="/img/1_5YfGDTsJG9hIDHADnp8_5Q.jpeg" title="Image" >}}
...
{{< image src="/img/1_9OqlCQm4XvSlf4QO7uU65w.jpeg" title="Image" >}}

If you’re interested in learning more about how MK Partners can help your organization roll-out Salesforce, and how we’ve helped similar organizations in the past — [give us a call](https://www.mkpartners.com/article/contact/contact)! And if you’d like to do some more reading on the subject (or have something to show off to the higher-ups), check out this handy booklet on all the benefits of choosing a CRM that cares!
Until then, keep up the good work! We’ll see you in the cloud.
