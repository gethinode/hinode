...
require (
	...
	github.com/gethinode/mod-blocks v1.6.0 // indirect
	github.com/gethinode/mod-bootstrap-icons v1.4.0 // indirect
	github.com/gethinode/mod-cookieyes/v2 v2.2.6 // indirect
	github.com/gethinode/mod-docs v1.2.0 // indirect
	github.com/gethinode/mod-fontawesome/v5 v5.0.6 // indirect
	github.com/gethinode/mod-utils/v5 v5.12.0 // indirect
